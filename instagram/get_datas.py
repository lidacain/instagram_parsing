...
def extract_data(driver, postlink):
    ...
    description_text = ''
    if description_div:
        description = description_div.find('span', class_='x193iq5w xeuugli x1fj9vlw x13faqbe x1vvkbs xt0psk2 x1i0vuye xvs91rp xo1l8bm x5n08af x10wh9bi x1wdrske x8viiok x18hxmgj')
...
def write_data_to_csv(data_list, output_filename):
...
def collect_data(driver, filename):
    data_list = []
...
if __name__ == "__main__":
    ...
    data_list = collect_data(driver, 'post_links_1.csv')
    write_data_to_csv(data_list, 'metadatas.csv')